...
<body id="page-top">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="{{asset('image/acounts/'.Auth::user()->gambar)}}">
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Imfea Software Solusindo 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
   ...
   {{-- select --}}
   <!-- Stylesheet -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.13/css/select2.min.css" integrity="sha512-5t6WreVUDXAOlxyaSugH5qufum8f8UOCjUxF5oLEWT5X8DzzeqH66aPkg0tsXbB8piv1V1NUcP1jYmt3xrKwrg==" crossorigin="anonymous" referrerpolicy="no-referrer" />
