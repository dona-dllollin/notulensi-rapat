...
class NotulenController extends Controller
{
    function index(){
        ...
        $tittle = 'Halaman Notulen';
        return view('halaman_notulen.index', compact('tittle', 'jenis', 'rapat', 'user'));
    }
    ...
    function profile($id){
        ...
        return view('halaman_notulen.profile', compact('user', 'tittle'));
    ...
    return view('halaman_notulen.edit', compact(['user', 'tittle']));
    }
    ...
    function change(Request $request)
    {
        ...
        return redirect('/profile/notulen/' . $request->id);
    }
}
